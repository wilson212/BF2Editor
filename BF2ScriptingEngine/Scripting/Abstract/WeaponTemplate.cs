...
namespace BF2ScriptingEngine.Scripting
{
    ...
    public class WeaponTemplate : ConFileObject
    {
        ...
        public virtual ObjectProperty<FiringPose> FiringPose { get; set; }
        ...
        protected virtual ObjectProperty<FiringPose> SetFiringPose { get; set; }
        ...
        public virtual ObjectProperty<double> AllowedDeviation { get; set; }
        ...
        public virtual ObjectProperty<double> Deviation { get; set; }
        ...
        public virtual ObjectProperty<int> DeviationCorrectionTime { get; set; }

        /// <summary>
        /// Gets or Sets the numerical button to activate this weapon?
        /// </summary>
        [PropertyName("weaponActivate")]
        public virtual ObjectProperty<PlayerInput> WeaponActivate { get; set; }

        /// <summary>
        /// Gets or Sets the firing button for this weapon
        /// </summary>
        [PropertyName("weaponFire")]
        public virtual ObjectProperty<PlayerInput> WeaponFire { get; set; }

        /// <summary>
        /// Gets or Sets the Weights assigned to chance of bots selecting this type target
        /// </summary>
        [PropertyName("setStrength")]
        public virtual ObjectPropertyDict<StrengthType, double> Strengths { get; set; }
        ...
        public virtual ObjectProperty<int> FireRate { get; set; }
        ...
        public virtual ObjectProperty<double> SoundSphereRadius { get; set; }
        ...
        public virtual ObjectProperty<bool> FiresThroughTransparent { get; set; }
